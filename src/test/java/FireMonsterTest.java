...
public void depleteLevels_reducesAllLevels(){
  ...
  @Test
  public void getFireLevel_instantiatesWithCorrectFireLevel_5() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
    assertEquals(5, testFireMonster.getFireLevel());
  }
  ...
  @Test
  public void kindling_recordsTimeLastKindlingInDB() {
    FireMonster testFireMonster = new FireMonster("Bubbles", 1);
    testFireMonster.save();
    testFireMonster.kindling();
    Timestamp savedFireMonsterKindling = FireMonster.find(testFireMonster.getId()).getLastKindling();
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance().format(rightNow), DateFormat.getDateTimeInstance().format(savedFireMonsterKindling));
  }
